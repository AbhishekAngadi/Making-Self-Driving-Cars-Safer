...
class SocialModel(nn.Module):
    ...
    def __init__(self, args, infer=False):
        ...
        # Grid size = 4, rnn_size = 128, outputsize = 5
    ...
    def getSocialTensor(self, grid, hidden_states):
        ...
        # each pedestrian has its own grid 
        ...
        for node in range(numNodes):
            ...
            # Multiply the social tensor by the hidden states
    ...
    def forward(self, *args):
        ...
        for framenum,frame in enumerate(input_data):
            ...
            #Variable(torch.zeros(numNodes, args.rnn_size))
            ...
            # Compute the social tensor
            #social_tensor.view(numNodes, self.grid_size*self.grid_size*self.rnn_size)
